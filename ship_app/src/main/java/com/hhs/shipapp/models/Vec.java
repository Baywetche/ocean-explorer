...
public class Vec {
  ...
  public static Vec fromJson(String json) throws JSONException {
    return fromJson(new JSONObject(json));
  }

  public static Vec fromJson(JSONArray ja) throws JSONException {
    if(ja.length()==3) {
  ...
  public static Vec fromJson(JSONObject jo) throws JSONException {
    try {
